...
| Project list | `src/content/projects.ts` | The projects: slug, title, one sentence, group, tags, links, architecture, and optional facts and case study; the filter groups; status and link helpers |
